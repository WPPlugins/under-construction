...
function get_option_pt()
{
    ...
    $options['social_twitter_link'] = $options['text_2'];
    $options['social_facebook'] = $options['checkbox_7'];
    $options['social_facebook_link'] = $options['text_3'];
    $options['social_digg'] = $options['checkbox_8'];
    $options['social_digg_link'] = $options['text_4'];
    $options['social_yahoo'] = $options['checkbox_9'];
    $options['social_yahoo_link'] = $options['text_5'];
    $options['social_delicious'] = $options['checkbox_10'];
    $options['social_delicious_link'] = $options['text_6'];
    $options['social_rss'] = $options['checkbox_11'];
    $options['social_rss_link'] = $options['text_7'];
    $options['social_flickr'] = $options['checkbox_12'];
    $options['social_flickr_link'] = $options['text_8'];
    $options['social_stumbleupon'] = $options['checkbox_13'];
    $options['social_stumbleupon_link'] = $options['text_9'];
    return $options;
}
...
function plugin_init_fn(){
    ...
    add_settings_field('text_2', 'Twitter link', 'build_text_option', 'under_construction', 'social_section');
    add_settings_field('check_box_7', 'Enable Facebook', 'build_checkbox_option', 'under_construction', 'social_section');
    add_settings_field('text_3', 'Facebook Link', 'build_text_option', 'under_construction', 'social_section');
    add_settings_field('check_box_8', 'Enable Digg', 'build_checkbox_option', 'under_construction', 'social_section');
    add_settings_field('text_4', 'Digg link', 'build_text_option', 'under_construction', 'social_section');
    add_settings_field('check_box_9', 'Enable Yahoo', 'build_checkbox_option', 'under_construction', 'social_section');
    add_settings_field('text_5', 'Yahoo link', 'build_text_option', 'under_construction', 'social_section');
    add_settings_field('check_box_10', 'Enable Delicious', 'build_checkbox_option', 'under_construction', 'social_section');
    add_settings_field('text_6', 'Delicious link', 'build_text_option', 'under_construction', 'social_section');
    add_settings_field('check_box_11', 'Enable RSS', 'build_checkbox_option', 'under_construction', 'social_section');
    add_settings_field('text_7', 'Rss link', 'build_text_option', 'under_construction', 'social_section');
    add_settings_field('check_box_12', 'Enable Flickr', 'build_checkbox_option', 'under_construction', 'social_section');
    add_settings_field('text_8', 'Flickr link', 'build_text_option', 'under_construction', 'social_section');
    add_settings_field('check_box_13', 'Enable Stumble Upon', 'build_checkbox_option', 'under_construction', 'social_section');
    add_settings_field('text_9', 'Stumble Upon link', 'build_text_option', 'under_construction', 'social_section');
}
